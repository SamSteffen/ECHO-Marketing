# A Visual Analysis of ECHO Idaho's Email Marketing Campaigns, 2018-2021
...
1. iECHO - An ECHO program-specific online database where personal info (name, email, credential, workplace, residence, etc.) as well as series and session attendance records are stored;
2. MailChimp - The University of Idaho's main communications system, which stores and preserves metrics for each campaign such as: how many people received each email, how many times it was opened, how many times it was forwarded, how many links were clicked, etc.;
3. eeds - An online platform where healthcare professionals are able to create and track continuing education credits earned for participation in ECHO Idaho and other event-based CE;
4. SoundCloud - The host site of ECHO Idaho's CE-eligible podcast, Something for the Pain.
...
2018 - Opioid Addiction and Treatment series (eventually became "Opioids, Pain and Substance Use 
...
This dataframe illustrates attendance records, as captured by iECHO, for all ECHO sessions in 2018:

![](Visualizations/2018/Session_attendance_totals_2018.png)

The following line chart illustrates the data from the above dataframe:

![](Visualizations/2018/Session_attendance_2018.png)

##### 2018 Attendance by Series

This graph illustrates attendance for ECHO Idaho's Opioids, Pain and Substance Use Disorder series in 2018:

![](Visualizations/2018/Email_v_attendance_OPSUD_2018.png)

This graph illustrates attendance for ECHO Idaho's Behavioral Health in Primary Care series in 2018:

![](Visualizations/2018/Email_v_attendance_BH_in_PC_2018.png)


### 2019 Analysis
##### 2019 Email Campaigns
...
##### 2019 Attendance by Series

This graph illustrates attendance for ECHO Idaho's Opioids, Pain and Substance Use Disorder series in 2019:

![](Visualizations/2019/Email_v_attendance_OPSUD_2019.png)

This graph illustrates attendance for ECHO Idaho's Behavioral Health in Primary Care series in 2019:

![](Visualizations/2019/Email_v_attendance_BH_in_PC_2019.png)


### 2020 Analysis
##### 2020 Email Campaigns
...
##### 2020 Attendance by Series



### 2021 Analysis
##### 2021 Email Campaigns
...
##### 2021 Attendance by Series


### Cumulative Analysis
##### Cumulative Email Campaigns

The barchart below shows the quantity of emails sent across ECHO series in 2018:


##### Cumulative Attendance Totals

##### Cumulative Attendance by Series
