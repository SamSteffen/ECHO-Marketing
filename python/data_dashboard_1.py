...
mytitle = dcc.Markdown(children='# ECHO Idaho Email Marketing Data')
...
def update_graph(user_input):  # function arguments come from the component property of the Input
    if user_input == 'All (2018-2021)':
        fig = px.bar(series_totals_df, x='Email Count', y='Series',
             ...
             title='Email Campaigns by ECHO Series (2018-2021)',
        ...
        fig = px.bar(series_totals_2021_df, x='Email Count', y='Series',
             ...
             color='Series',
             labels={'Series':'ECHO Email Campaign', 'Email Count':'Email Quantity'},
             title='Email Campaigns by ECHO Series (2021)',
